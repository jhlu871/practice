# -*- coding: utf-8 -*-
"""
Created on Mon Sep 19 18:05:55 2016
...
def obtain_topic_tags():
    ...
    """
    with open('reuters/all-topics-strings.lc.txt') as tops:
        topics = [t.strip() for t in tops]
        return topics
...
if __name__ == "__main__":
    ...
    #filename = "reuters/reut2-000.sgm"
    ...
    docs = filter_doc_list_through_topics(topics,docs)
